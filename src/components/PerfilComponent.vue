<template>
    <v-card width="90%" :variant="theme === 'dark' ? 'elevated' : 'outlined'" >
        ...
        <v-card-text>
            <v-badge  color="error" content="from El salvador" offset-x="10" offset-y="10">
   ...
   /_/ \_\__,_|_| |_\__,_|_||_| /_/ \_\__, |\_,_|_|_\___|_| \__,_|
            ...
            <v-card-text>
                <p class="pb-5">
                    <span class="text-green-accent-3">~ dir/myself </span>
                    <br>
                    <span class="text-green-accent-3">~ {{ myself }} </span>
                    <br>
                </p>
            </v-card-text>
            <v-divider :thickness="5" class="pb-4"></v-divider>
            <v-card-text>
                ...
                <p class="pb-5">
                    <span class="text-green-accent-3">~ ls -skills </span>
                    <br>
